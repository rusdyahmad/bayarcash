...
/**
 * DuitNow QR Payment Channel
 */
class DuitnowQrChannel extends AbstractChannel
{
    /**
     * Channel ID
     */
    protected int $channelId = 6;
    
    /**
     * Channel name
     */
    protected string $channelName = 'DuitNow QR';
    ...
    protected function preparePaymentData(array $data): array
    {
        ...
        // Add any DuitNow QR-specific data transformations here
